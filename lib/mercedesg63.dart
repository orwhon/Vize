...
class MercedesG63 extends StatefulWidget {
  @override
  _MercedesG63State createState() => _MercedesG63State();
}

class _MercedesG63State extends State<MercedesG63> {
  int x=0;
      ...
      body: SafeArea(
        child: Column(children: [
          GestureDetector(
            ...
            child: x%2==1?Image.asset('assets/images/Mercedes/MercedesAmg.jpg'):Image.asset('assets/images/Mercedes/Mercedesg63.jpg',
              height: 250,),
          ),
          Divider(height: 5),
          Column(
            children: [
              ...
              Divider(height: 3,),
              Text('Model: G63', style: TextStyle(fontSize: 20),),
              Divider(height: 3,),
